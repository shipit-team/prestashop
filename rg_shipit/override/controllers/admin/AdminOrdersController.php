...
class AdminOrdersController extends AdminOrdersControllerCore
{
    ...
    public function __construct()
    {
        ...
        $this->bulk_actions = array(
            ...
            'sendOrderShipit' => array('text' => 'Enviar a Shipit', 'confirm' => 'your message to user')
        );
    }
    ...
    protected function processBulkSendOrderShipit(){
        if (is_array($this->boxes) && !empty($this->boxes)){
            ...
            foreach ($this->boxes as $id_order){
                ...
                array_push($massive_orders, $shipit_order->build());
            ...
            $orders = $api_order->massiveOrders(['orders' => $massive_orders]);
        }
    }
