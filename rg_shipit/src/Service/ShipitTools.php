...
class ShipitTools
{
     ...
     */
    public static function getProductsVolume($shipit_set_value_width, $shipit_set_value_height, $shipit_set_value_depth, $shipit_set_dimensions, $cart)
    {
        $s_width = (float)$shipit_set_value_width;
        $s_height = (float)$shipit_set_value_height;
        $s_depth = (float)$shipit_set_value_depth;

        switch ($shipit_set_dimensions) {
     ...
     */
    public static function getProductsWeight($shipit_set_value_weight, $shipit_set_weight, $cart)
    {
        $s_weight = (float)$shipit_set_value_weight;

        switch ($shipit_set_weight) {
     ...
     */
    public static function convertToKg($ps_weight_unit, $val)
    {
        if ($val) {
            $unit = $ps_weight_unit;
     ...
     */
    public static function convertToCm($ps_dimension_unit, $val)
    {
        if ($val) {
            $unit = $ps_dimension_unit;
